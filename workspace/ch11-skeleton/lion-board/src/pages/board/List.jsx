...
export default function List() {
  ...
  return (
    <>
      <Helmet>
        <title> {printListType(type)}- 멋사컴</title>

        <meta property="og:title" content={`${printListType(type)} - 멋사컴`} />
        <meta
          property="og:description"
          content={`멋사컴 ${printListType(type)}입니다.`}
        />
      </Helmet>
